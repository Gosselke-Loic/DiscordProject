(function () {
    ...
    class NamedCacheStorage {
      ...
      keys() {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          const ownCacheNames = allCacheNames.filter(name =>
      ...
      open(cacheName) {
        return __awaiter(this, void 0, void 0, function* () {
          const cache = yield this.original.open(
            `${this.cacheNamePrefix}:${cacheName}`,
          );
    ...
    class Adapter {
      constructor(scopeUrl, caches) {
        ...
        this.caches = new NamedCacheStorage(
          caches,
          `ngsw:${parsedScopeUrl.path}`,
        );
      }
      /**
    ...
    class CacheDatabase {
      ...
      list() {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          const dbCacheNames = allCacheNames.filter(name =>
            name.startsWith(prefix),
          );
      ...
      open(name, cacheQueryOptions) {
        return __awaiter(this, void 0, void 0, function* () {
          if (!this.tables.has(name)) {
            const cache = yield this.adapter.caches.open(
              `${this.cacheNamePrefix}:${name}`,
            );
            const table = new CacheTable(
              name,
              cache,
              this.adapter,
              cacheQueryOptions,
    ...
    class AssetGroup {
      constructor(scope, adapter, idle, config, hashes, db, cacheNamePrefix) {
        ...
        this.cache = adapter.caches.open(
          `${cacheNamePrefix}:${config.name}:cache`,
        );
        ...
        this.metadata = this.db.open(
          `${cacheNamePrefix}:${config.name}:meta`,
    ...
    class DataGroup {
      constructor(scope, adapter, config, db, debugHandler, cacheNamePrefix) {
        ...
        this.lruTable = this.db.open(
          `${cacheNamePrefix}:${config.name}:lru`,
          config.cacheQueryOptions,
        );
        this.ageTable = this.db.open(
          `${cacheNamePrefix}:${config.name}:age`,
          config.cacheQueryOptions,
        );
      }
      /**
      ...
      handleFetchWithPerformance(req, event, lru) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          if (fromCache !== null) {
            ...
            if (
              this.config.refreshAheadMs !== undefined &&
              fromCache.age >= this.config.refreshAheadMs
            ) {
              event.waitUntil(
                this.safeCacheResponse(req, this.safeFetch(req), lru),
              );
            }
          }
          if (res !== null) {
      ...
      networkFetchWithTimeout(req) {
        ...
        if (this.config.timeoutMs !== undefined) {
          ...
          return [
            Promise.race([networkFetchUndefinedError, timeout]),
            safeNetworkFetch,
          ];
        } else {
      ...
      clearCacheForUrl(url) {
        return __awaiter(this, void 0, void 0, function* () {
          const [cache, ageTable] = yield Promise.all([
            this.cache,
            this.ageTable,
          ]);
          yield Promise.all([
    ...
    class AppVersion {
      constructor(
        ...
        manifest.navigationUrls =
          manifest.navigationUrls || BACKWARDS_COMPATIBILITY_NAVIGATION_URLS;
      ...
      handleFetch(req, event) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          const asset = yield this.assetGroups.reduce(
            (potentialResponse, group) =>
              __awaiter(this, void 0, void 0, function* () {
          ...
          const data = yield this.dataGroups.reduce(
            (potentialResponse, group) =>
              __awaiter(this, void 0, void 0, function* () {
                const resp = yield potentialResponse;
                if (resp !== null) {
          ...
          if (
            ...
            return this.handleFetch(
              this.adapter.newRequest(this.indexUrl),
              event,
            );
          }
          return null;
      ...
      isNavigationRequest(req) {
        ...
        const url = req.url.startsWith(urlPrefix)
          ? req.url.substr(urlPrefix.length)
          : req.url;
        const urlWithoutQueryOrHash = url.replace(/[?#].*$/, '');
        return (
          this.navigationUrls.include.some(regex =>
            regex.test(urlWithoutQueryOrHash),
          ) &&
          !this.navigationUrls.exclude.some(regex =>
            regex.test(urlWithoutQueryOrHash),
          )
        );
      }
  ...
  ${msgIdle}`,
      ...
      formatDebugLog(log) {
        return log
          .map(
            entry =>
              `[${this.since(entry.time)}] ${entry.value} ${entry.context}`,
          )
          .join('\n');
      }
    }
      ...
      trigger() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
          ...
          const maxDelay = Math.max(
            0,
            ((_a = this.oldestScheduledAt) !== null && _a !== void 0 ? _a : now) +
              this.maxDelay -
              now,
          );
    ...
    var DriverReadyState = /*@__PURE__*/ (function (DriverReadyState) {
      ...
      DriverReadyState[(DriverReadyState['EXISTING_CLIENTS_ONLY'] = 1)] =
    ...
    class Driver {
      constructor(scope, adapter, db) {
        ...
        this.ngswStatePath = this.adapter.parseUrl(
          'ngsw/state',
      ...
      onFetch(event) {
        ...
        if (
          ...
          /[?&]ngsw-bypass(?:[=&]|$)/i.test(requestUrlObj.search)
        ) {
          return;
        }
        ...
        if (
          requestUrlObj.origin.startsWith('http:') &&
          scopeUrl.startsWith('https:')
        ) {
          // Still, log the incident for debugging purposes.
          this.debugger.log(
            `Ignoring passive mixed content request: Driver.fetch(${req.url})`,
          );
          return;
        }
      ...
      ensureInitialized(event) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            ...
            this.stateMessage = `Initialization failed due to error: ${errorToString(
              error,
            )}`;
            throw error;
          } finally {
      ...
      handleMessage(msg, from) {
        return __awaiter(this, void 0, void 0, function* () {
          if (isMsgCheckForUpdates(msg)) {
            ...
            yield this.reportStatus(
              from,
              this.updateClient(from),
              msg.statusNonce,
            );
          }
        });
        ...
        return __awaiter(this, void 0, void 0, function* () {
          ...
          switch (
            ...
            case 'focusLastFocusedOrOpen': {
              ...
              if (matchingClient) {
                yield matchingClient === null || matchingClient === void 0
                  ? void 0
      ...
      updateClient(client) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          if (existing !== undefined) {
            ...
            previous = this.mergeHashWithAppData(
              existingVersion.manifest,
              existing,
            );
          }
      ...
      handleFetch(event) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          if (
            ...
            !this.scheduledNavUpdateCheck
          ) {
            this.scheduledNavUpdateCheck = true;
            this.idle.schedule('check-updates-on-navigation', () =>
              __awaiter(this, void 0, void 0, function* () {
                this.scheduledNavUpdateCheck = false;
                yield this.checkForUpdate();
              }),
      ...
      initialize() {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            ...
            if (
              !this.versions.has(latest.latest) &&
          ...
          yield Promise.all(
            Object.keys(manifests).map(hash =>
              __awaiter(this, void 0, void 0, function* () {
                try {
            ...
            if (this.clientVersionMap.has(clientId)) {
              ...
              if (
                ...
                if (this.latestHash === null) {
                  throw new Error(
                    `Invariant violated (assignVersion): latestHash was null`,
                  );
                }
                ...
                appVersion = this.lookupVersionByHash(
                  this.latestHash,
                  'assignVersion',
                );
              }
      ...
      fetchLatestManifest(ignoreOfflineError = false) {
        return __awaiter(this, void 0, void 0, function* () {
          const res = yield this.safeFetch(
      ...
      deleteAllCaches() {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          yield Promise.all(
            cacheNames.map(name => this.adapter.caches.delete(name)),
          );
        });
      }
      /**
      ...
      scheduleInitialization(appVersion) {
        return __awaiter(this, void 0, void 0, function* () {
          const initialize = () =>
            __awaiter(this, void 0, void 0, function* () {
              try {
                ...
                this.debugger.log(
                  err,
                  `initializeFully for ${appVersion.manifestHash}`,
                );
                yield this.versionFailed(appVersion, err);
              }
            });
          ...
          this.idle.schedule(
            `initialization(${appVersion.manifestHash})`,
            initialize,
          );
        });
      }
        ...
        return __awaiter(this, void 0, void 0, function* () {
          ...
          if (this.latestHash === brokenHash) {
            ...
            affectedClients.forEach(clientId =>
              this.clientVersionMap.delete(clientId),
            );
          } else {
          ...
          try {
            ...
            this.debugger.log(
              err2,
              `Driver.versionFailed(${err.message || err})`,
            );
          }
        });
      }
      ...
      checkForUpdate() {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            ...
            this.debugger.log(
              err,
              `Error occurred while updating to manifest ${hash}`,
            );
            this.state = DriverReadyState.EXISTING_CLIENTS_ONLY;
            this.stateMessage = `Degraded due to failed initialization: ${errorToString(
              err,
            )}`;
            return false;
          }
        ...
        return __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            const activeClients = new Set(
              (yield this.scope.clients.matchAll()).map(client => client.id),
            );
            ...
            const obsoleteClients = knownClients.filter(
              id => !activeClients.has(id),
            );
            ...
            const obsoleteVersions = Array.from(this.versions.keys()).filter(
              version =>
                !usedVersions.has(version) && version !== this.latestHash,
            );
            ...
            const cachesToDelete = allCaches.filter(
              name => !usedCaches.has(name),
            );
            yield Promise.all(
              cachesToDelete.map(name => this.adapter.caches.delete(name)),
            );
          } catch (err) {
      ...
      cleanupOldSwCaches() {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          const oldSwCacheNames = cacheNames.filter(name =>
            /^ngsw:(?!\/)/.test(name),
          );
      ...
      recentCacheStatus(url) {
        return __awaiter(this, void 0, void 0, function* () {
          const version = this.versions.get(this.latestHash);
          return version
            ? version.recentCacheStatus(url)
            : UpdateCacheStatus.NOT_CACHED;
        });
      }
            ...
            clients.map(client =>
              __awaiter(this, void 0, void 0, function* () {
                ...
                const notice = {
                  ...
                  available: this.mergeHashWithAppData(
                    next.manifest,
                    this.latestHash,
                  ),
                };
      ...
      getCacheNames() {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          const appVersionCacheNames = yield Promise.all(
