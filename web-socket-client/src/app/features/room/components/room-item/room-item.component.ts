...
import { updateItem } from "src/app/shared/utils/upsert-item";
import { User } from "src/app/features/auth/service/auth.service";
import { Room, RoomService } from "../../service/room.service";
import { ActionType, UpsertRoomDialogComponent } from "../upsert-room-dialog/upsert-room-dialog.component";
...
export class RoomItemComponent implements OnInit {
    ...
    joinRoom() {
        ...
        this.roomService
            ...
            .pipe(take(1), tap({next: () => process, complete: () => process}))
