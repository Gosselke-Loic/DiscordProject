...
import { UserGateway } from "./gateaway/user.gateaway";
...
export class UserModule implements OnModuleInit, OnModuleDestroy {
    constructor(private socketConnetionService: SocketConnectionService) {}
    ...
    private deleteConnections() {
        return this.socketConnetionService.deleteAllConnections();
    }
}